...
update
{
	...
	vars.LoadScreenA = vars.Resolver.CheckFlag("LoadScreenShowing") || vars.LoadScreenA;
	vars.LoadScreenB = vars.Resolver.CheckFlag("LoadScreenShowing2") || vars.LoadScreenB;
	vars.Loading = vars.LoadScreenA && vars.LoadScreenB;
