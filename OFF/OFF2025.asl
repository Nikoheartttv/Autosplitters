...
startup
{
    ...
    vars.splits = new Dictionary<string, Func<dynamic, dynamic, bool>>()
    {
        ...
        {"chapter5",             (org, cur) => cur.mapID == 293 && cur.eventID == 6 && org.pageIndex != 3 && cur.pageIndex == 3},
        {"chapter4",             (org, cur) => cur.mapID == 293 && cur.eventID == 6 && org.pageIndex != 5 && cur.pageIndex == 5},
        {"chapter3",             (org, cur) => cur.mapID == 293 && cur.eventID == 6 && org.pageIndex != 7 && cur.pageIndex == 7},
