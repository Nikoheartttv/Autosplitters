...
startup
{
	...
	dynamic[,] _settings =
	{
		...
		{ "FullGame", true, "Full Game", null },
			{ "FromMemoryLoad", false, "From Memory Load Timer Start", "FullGame" },
			...
			{ "WaterWorks", false, "Water Works", "FullGame" },
				{ "WaterWorks2", false, "Enter Split Decision (Green Water Tunnel)", "WaterWorks" },
				...
				{ "NormalPath", false, "Normal Path", "WaterWorks" },
					{ "WaterWorks3", false, "Enter Maintence Door", "NormalPath" }, 
					{ "ChildhoodMemories3" , false, "Enter Childhood Memories (Normal)", "NormalPath" },
			{ "ChildhoodMemories", false, "Childhood Memories", "FullGame" },
			...
			{ "BounceHouse", false, "Bounce House", "FullGame" },
...
init
{
	...
	switch (hash)
	{
		...
		case "D54FC4A4A1949FD9141F89607038AA55":
			...
			break;
		case "BAA42D58A107D13601C4B82C06FFD87C":
			version = "Demo v1.5.3 (09.05.26)";
			break;
		case "CC7F1C165C34F7211F7713B55FC53781":
			version = "Demo v1.5.3.1 (09.05.26)";
			break;
		case "65A5E403DFAA1F55480386E41BDA3E5A":
			version = "Demo v1.5.3.2 (14.05.26)";
			break;
		case "84311CED5B9840869244710CADE252B3":
			version = "Demo v1.5.3.3 (15.05.26)";
			break;
		case "0FC759C046CE8076BDCEF796A4024529":
		case "34686B7407DE27AD3F47573B9573651E":
			version = "Demo v1.5.3.4 (09.06.26)";
			break;
		case "1FB07E641661052BD0082FE2DEAF2E87":
			version = "Demo v1.5.3.5 (18.06.26)";
			break;
		// Full Game
		...
		case "66C4448B95CB07BC3BF1623402D7BF86":
			...
			break;
		case "FAD0265C51F8AA1410FB446CA25EC84C":
			version = "Full Game v1.0.3";
			break;
		case "F717C772C8AD6D0ACE21609C5E250982":
			version = "Full Game v1.0.3.1";
			break;
		case "3A1801060030A31C44E4AA6E10994579":
			version = "Full Game v1.0.3.2";
			break;
		...
		case "B59C8A0FA9BBDA4ADCD192E64A23C1D5":
	...
	switch(version)
	{
		...
		case "Full Game v1.0.3.5":
			...
			vars.Resolver.Watch<bool>("Loading", vars.Utils.GEngine, 0x12C8, 0x1D0, 0xFD9);
			break;
	}
	...
	else 
	{
		...
		vars.Events.FunctionFlag("DarkChildhoodMemories1Split", "BP_CMDarkPt1Intro_C", "", "ExecuteUbergraph_BP_CMDarkPt1Intro");
...
start
{
	...
	if (version.Contains("Full Game") && !vars.NewGameStart && settings["FromMemoryLoad"])
...
split
{
	...
	// End Split
	if (vars.CreditsActive && vars.DoSplit("CreditsSplit", settings["EndSplit"], "EndSplit")) return true;
}
