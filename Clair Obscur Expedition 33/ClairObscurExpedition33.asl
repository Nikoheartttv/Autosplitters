...
init
{
    ...
    vars.Resolver.Watch<ulong>("CS_EventBeforePostCinematicTransitionStarted", vars.Utils.GEngine, 0x10A8, 0x38, 0x0, 0x30, 0x8A8, 0x298);
    vars.Uhara["CS_EventBeforePostCinematicTransitionStarted"].FailAction = MemoryWatcher.ReadFailAction.DontUpdate;
...
update
{
    ...
    if (vars.WaitForVersion)
    {
        ...
        switch (projectVersion)
        {
            ...
            default:
                ...
                int parsedVersion;
                vars.MiniMapOffsetOld = int.TryParse(cleanVersion, out parsedVersion) && parsedVersion <= 1310;
                break;
        }
    ...
    {
        bool miniMapOld = vars.Resolver.Read<bool>("MiniMapActive", vars.Utils.GEngine, 0x10A8, 0x38, 0x0, 0x30, 0x980, 0x3C8, 0x368);
        bool miniMapNew = vars.Resolver.Read<bool>("MiniMapActive", vars.Utils.GEngine, 0x10A8, 0x38, 0x0, 0x30, 0x980, 0x3D0, 0x368);
        current.MiniMapActive = vars.MiniMapOffsetOld ? miniMapOld : miniMapNew;
